...
/*
6.- Escribir  un programa que lea 3 números los cuales significan una fecha (día, mes, año). 
...
int main(){
	...
	Fecha fecha;
	//LLamamos al metodo validar de la clase fecha para verificar
	fecha.Menu();
