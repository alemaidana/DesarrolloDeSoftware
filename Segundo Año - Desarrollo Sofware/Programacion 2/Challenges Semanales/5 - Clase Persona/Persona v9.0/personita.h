...
class Persona{
    ...
    public:
        Persona();      
        void ActualizarDatos(int, char[20], char[20], char[20], char[20],char[20],char[20],char[20]);
        void Imprimir();
        int obtenerCodigo();
...
void Persona::ActualizarDatos(int c, char n[20], char a[20], char ca[20],char dn[20],char te[20], char co[20], char fn[20]){
